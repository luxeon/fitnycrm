...
-- User without tenant
INSERT INTO users(id, first_name, last_name, email, phone_number, password)
VALUES('a35ac7f5-3e4f-462a-a76d-524bd3a5fd02', 'Jane', 'Smith', 'jane.smith@gmail.com', '+111222333', '$2a$10$6ndbi.td4IJOnRhr3VvfwOG2dr4X4l.9SAZRsFo5y2ukcz697LXOG');
...
INSERT INTO users(id, first_name, last_name, email, phone_number, password)
VALUES('b35ac7f5-3e4f-462a-a76d-524bd3a5fd03', 'Test', 'User', 'test.user@gmail.com', '+444555666', '$2a$10$6ndbi.td4IJOnRhr3VvfwOG2dr4X4l.9SAZRsFo5y2ukcz697LXOG');
